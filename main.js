...
var registroEmisor = [
    new Emisor("1", "Jhon Acosta", "San Juan", "Quito", "Sucursal Sur"),
    new Emisor("2", "Jhona Torres", "Quitumbe", "Quito", "Concesionaria Jhona"),
    new Emisor("3", "Kevin Montalvo", "CCI", "Quito", "Sucursal Norte"),
]
...
document.getElementById("enviar")
    .addEventListener("click", function () {
        ...
        if (typeof emisor === "undefined") {
            ...
            alert("SU PEDIDO FUE ENVIADO CORRECTAMENTE");
